      ...
      <div className="flex-vid mb-32 lg:mb-40">
          ...
          <div className="vid-cont flex lg:flex-row flex-col">
            ...
            <div className="right-vid lg:ml-16 lg:w-[50%] mt-5">
                <a href="https://yands.netlify.app/" target={`_blank`} className='flex items-center hover:text-[#7794FF] ease-in duration-300'>
                  <h1 className='lg:text-3xl text-2xl font-medium'>Y & S (Fullstack Ecommerce store)</h1>
                  <BsArrowUpRightCircle className='lg:text-3xl text-2xl ml-5'/>
                </a>
                <p className='mt-5 text-lg font-light'>This project was built using NodeJS, React and TailwindCSS, this project aimed to Build a fully functional and interactive Ecommerce store</p>
                <div className="tags mt-10 flex items-center flex-wrap mt-[-2px] mr-[-3px]">
                  <span className='text-base text-slate-300 px-7 py-2 border rounded-full text-sm tracking-widest mt-[15px] lg:mr-[3px] mr-[15px] lg:ml-3'>NodeJS</span>
                  <span className='text-base text-slate-300 px-7 py-2 border rounded-full text-sm tracking-widest mt-[15px] lg:mr-[3px] mr-[15px] lg:ml-3'>MongoDB</span>
                  <span className='text-base text-slate-300 px-7 py-2 border rounded-full text-sm tracking-widest mt-[15px] lg:mr-[3px] mr-[15px] lg:ml-3'>Mongoose</span>
